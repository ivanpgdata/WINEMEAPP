...
if selected == "Quiénes somos":
    ...
    with col1:  # To display the header text using css style
        with st.container():
            ...
            url_pic_maria = f"https://drive.google.com/file/d/{file_maria_id}/view"
    ...
    with col2:
        ...
        url_pic_ivan = f"https://drive.google.com/file/d/{file_ivan_id}/view"
    ...
    with col3:
        ...
        url_pic_soraya = f"https://drive.google.com/file/d/{file_soraya_id}/view"
